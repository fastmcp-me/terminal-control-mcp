...
def test_automation_engine():
    ...
    AutomationEngine(session_manager)
...
def test_imports():
    ...
    try:
        ...
        from interactive_automation_mcp.main import mcp  # noqa: F401
        ...
        raise AssertionError(f"Failed to import main server: {e}") from e
...
async def main():
    ...
    # Test imports first
    test_imports()  # This will raise if it fails
